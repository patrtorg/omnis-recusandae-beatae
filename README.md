...
[![codecov]](https://codecov.io/github/beaugunderson/@patrtorg/omnis-recusandae-beatae?branch=master)
[![downloads]](https://www.npmjs.com/package/@patrtorg/omnis-recusandae-beatae)
[![npm]](https://www.npmjs.com/package/@patrtorg/omnis-recusandae-beatae)
[![snyk]](https://snyk.io/test/github/beaugunderson/@patrtorg/omnis-recusandae-beatae)

[codecov]: https://codecov.io/github/beaugunderson/@patrtorg/omnis-recusandae-beatae/coverage.svg?branch=master
[downloads]: https://img.shields.io/npm/dm/@patrtorg/omnis-recusandae-beatae.svg
[npm]: https://img.shields.io/npm/v/@patrtorg/omnis-recusandae-beatae.svg
[snyk]: https://snyk.io/test/github/beaugunderson/@patrtorg/omnis-recusandae-beatae/badge.svg

## @patrtorg/omnis-recusandae-beatae

`@patrtorg/omnis-recusandae-beatae` is a library for validating and manipulating IPv4 and IPv6
addresses in JavaScript.


### Migrating from 6.x to 7.x

`@patrtorg/omnis-recusandae-beatae` was rewritten in TypeScript for version 7. If you were using
...
Documentation is available at [@patrtorg/omnis-recusandae-beatae.js.org](http://@patrtorg/omnis-recusandae-beatae.js.org/).
